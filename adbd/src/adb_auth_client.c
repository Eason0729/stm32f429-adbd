...
static char* key_paths[] = {"/adb_keys", "/data/misc/adb/adb_keys", NULL};
...
void adb_auth_confirm_key(unsigned char* key, size_t len, atransport* t)
{
    ...
    ret = snprintf(msg, MAX_PAYLOAD, "PK%s", key);
    if(ret >= (signed)MAX_PAYLOAD) {
        free(msg);
